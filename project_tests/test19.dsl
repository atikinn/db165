...
--
-- Query in SQL:
-- SELECT max(col1+col5)
-- FROM tbl2
-- WHERE col1 >= 21000000 and col1 < 510000000
--   and col7 >= 61000000 and col7 < 1010000000
--   and col6 >= 410000000 and col6 < 8100000000
--
...
s3=select(s2,f2,410000000,null)
f3=fetch(db1.tbl2.col1,s3)
f4=fetch(db1.tbl2.col5,s3)
sum=add(f3,f4)
m=max(sum)
tuple(m)
